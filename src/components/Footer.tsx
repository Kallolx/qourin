          ...
          <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/10">
            ...
            <div className="py-12 md:pr-8 border-l border-white/10">
              <div className="flex flex-col space-y-8 pl-8 md:pl-12">
                {/* Email Subscribe */}
                <div>
                  <h3 className="text-lg mb-4">Subscribe to our newsletter for industry insights and company news!</h3>
                ...
                <div>
                  <button
                    ...
                    className="flex items-center gap-3 text-[15px] border border-white/20 rounded-full px-4 py-1.5 hover:bg-white/5 transition-colors"
                  >
