        ...
        <div className="relative h-[300px] md:h-[400px] mb-8 md:mb-12">
          ...
          <div className="relative h-full grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative hidden md:block">
              ...
              <div className="absolute bottom-0 right-0 w-1/3 h-full bg-white transform skew-x-12 translate-x-1/2" />
            </div>
            
            {/* Right Side */}
            <div className="relative flex items-center justify-center">
              <div className="bg-white/90 md:bg-white py-6 px-8 md:py-8 md:px-12 transform md:-translate-x-1/4 w-full md:w-auto">
                ...
                <h2 className="text-3xl md:text-4xl text-gray-900 font-light text-center">How we work</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          {steps.map((step, index) => (
            <motion.div
              ...
              className={`cursor-pointer transition-all duration-500 ease-in-out relative group ${
                activeStep === index ? 'bg-gray-50' : 'bg-white'
              }`}
              ...
              <div className="p-4 md:p-6">
                <div className="flex items-baseline gap-2 md:gap-3 mb-3 md:mb-4">
                  <span className={`text-xl md:text-2xl font-light transition-colors duration-500 ease-in-out ${
                    activeStep === index ? 'text-teal-600' : 'text-gray-400'
                  }`}>
                    {step.number}
                  </span>
